...
import { watermarkAddApi, watermarkUpdateApi } from '@/api/watermark.js'
...
const onSubmit = async () => {
  ...
  try {
    if (formModel.value._id) {
      // 编辑
      const upRes = await watermarkUpdateApi(formModel.value._id, formModel.value.name, formModel.value.images)
